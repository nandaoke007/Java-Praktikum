package com.mycompany.soal_prak_701;

import java.util.Scanner;
import java.io.*;

public class Soal_Prak_701 {
	...
	static void getKamar() {
		...
		try {
			File file = new File(
					"D:\\Java\\Praktikum-AnandaDwiOktafyan\\Soal_Prak_701\\src\\main\\java\\com\\mycompany\\soal_prak_701\\dataKamar.txt");
	...
	static void getPenyewa() {
		...
		try {
			File file = new File(
					"D:\\Java\\Praktikum-AnandaDwiOktafyan\\Soal_Prak_701\\src\\main\\java\\com\\mycompany\\soal_prak_701\\dataPenyewa.txt");
	...
	static void getTransaksi() {
		...
		try {
			File file = new File(
					"D:\\Java\\Praktikum-AnandaDwiOktafyan\\Soal_Prak_701\\src\\main\\java\\com\\mycompany\\soal_prak_701\\dataTransaksi.txt");
			Scanner input = new Scanner(file);
			while (input.hasNext()) {
				print(input.nextLine());
			}
	...
	static void getSingle() {
		...
		try {
			File file = new File(
					"D:\\Java\\Praktikum-AnandaDwiOktafyan\\Soal_Prak_701\\src\\main\\java\\com\\mycompany\\soal_prak_701\\room\\single.txt");
			BufferedReader input = new BufferedReader(new FileReader(file));
			String line;
			while ((line = input.readLine()) != null) {
				print(line);
	...
	static void getDouble() {
		...
		try {
			File file = new File(
					"D:\\Java\\Praktikum-AnandaDwiOktafyan\\Soal_Prak_701\\src\\main\\java\\com\\mycompany\\soal_prak_701\\room\\double.txt");
			BufferedReader input = new BufferedReader(new FileReader(file));
			String line;
			while ((line = input.readLine()) != null) {
				print(line);
	...
	static void getSuite() {
		...
		try {
			File file = new File(
					"D:\\Java\\Praktikum-AnandaDwiOktafyan\\Soal_Prak_701\\src\\main\\java\\com\\mycompany\\soal_prak_701\\room\\suite.txt");
			BufferedReader input = new BufferedReader(new FileReader(file));
			String line;
			while ((line = input.readLine()) != null) {
				print(line);
